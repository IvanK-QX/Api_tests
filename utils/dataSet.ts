...
export const apiDataSet = {
    ...
    lambdaStoplistsQAUrl: 'https://2dy2uz7et5bwusqjdhgnbgivqu0qdmbm.lambda-url.us-east-1.on.aws/',
    lambdaStoplistsProdUrl: 'https://u3h6t7yuxfexjplb6vrpyplbfy0kxvzx.lambda-url.us-east-1.on.aws/'
}
