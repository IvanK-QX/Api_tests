...
test.describe('Moderation service API test', async () => {
    ...
    test('Stream Logs page', async () => {
        ...
        // (bug PBA-2751) await api.streamLogsPage.screenshotSearch(apiUrl.qaEnvUrl, admin.adminToken, "moderatorId", "64b7cda846c38cbafbc6b19f")
        await api.streamLogsPage.screenshotSearch(apiUrl.qaEnvUrl, admin.adminToken, "streamType", "public")
        // (bug PBA-2766) await api.streamLogsPage.screenshotSearch(apiUrl.qaEnvUrl, admin.adminToken, "action", "endStream")
